...
app.use('/', indexRouter);  //login, signin, logout
...
app.use('/view-all-password/1', viewAllPassRouter);
app.use('/password-detail', passwordDetailsRouter);  // for edit nd delete password details
app.use('/joinResult', joinRouter);    // joins the complete details of the all passwords 
